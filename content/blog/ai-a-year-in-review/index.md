...
## From approving every tool call to running several agents
...
<!-- TODO: define "harness" here, before its first use below (was "harnesses meaning" in the tips list). -->
...
<!-- TODO: agents happily write E2E tests (see "Where agents surprised me"). The struggle is giving them an environment where they can run them and trust the result. -->

## My job is now the foundation
